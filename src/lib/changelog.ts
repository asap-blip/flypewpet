...
export const CHANGELOG: ChangelogEntry[] = [
  { date: "2026-05-26", summary: "Added Canadian carriers Porter, WestJet, Air Transat and Flair (economy, soft-sided-required) with published dimensions, weight limits and official source links. Flair in-cabin is domestic-Canada only." },
  { date: "2026-05-26", summary: "Re-verified all 8 original airlines against current public policy (May 2026). Corrected Air Canada and Lufthansa to soft-sided-required, and JetBlue to allow hard-sided (soft preferred). Sources cross-checked against current guides; airlines' own pages couldn't be fetched directly (bot-protected), so values reflect current published policy as cited by those sources." },
